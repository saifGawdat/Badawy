        ...
        >
          <div className="bg-secondary p-12 rounded-[3rem] text-white shadow-2xl relative overflow-hidden group">
            ...
            <p className="text-2xl font-serif italic leading-relaxed mb-8 relative z-10">
              {isArabic
                ? '«الجمال يبدأ عندما تلتقي الثقة بدقة الأيدي الماهرة. هدفنا ليس مجرد تغيير شكلي، بل تحول طبيعي يبرز جمالك الحقيقي.»'
          ...
          <div className="grid grid-cols-2 gap-8 pt-4">
            <div className="space-y-2">
              ...
              <p className="text-secondary/50 text-sm leading-tight uppercase font-medium tracking-wider">
                {isArabic ? 'تعافٍ سلس ونتائج طبيعية' : 'Smooth recovery and natural results'}
              </p>
            </div>
            <div className="space-y-2">
              <h4 className="text-6xl font-serif text-secondary tracking-tighter">15k+</h4>
              <p className="text-secondary/50 text-sm leading-tight uppercase font-medium tracking-wider">
                {isArabic ? 'مرضى راضون حول العالم' : 'Satisfied patients worldwide'}
              </p>
            </div>
          </div>
        </motion.div>
